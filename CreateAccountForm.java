...
public class CreateAccountForm extends javax.swing.JFrame {
     ...
     */
    public static loginForm logf;
    public CreateAccountForm(loginForm logf1) {
        initComponents();
        logf = logf1;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        HashMap<String,String> all_users = new HashMap<String,String>();
	BufferedWriter bw = null;
	FileWriter fw = null;
	PrintWriter pw = null;
        String filename = "src/myswimapp/users.txt";
        String newu = jTextField1.getText();
        String newp =jPasswordField1.getText();
        String conp =jPasswordField2.getText();
        try {
            logf.l.set_username(newu);
            logf.l.set_password(newp);
            logf.l.create_account(filename, all_users, bw, fw, pw,newu,newp,conp);
